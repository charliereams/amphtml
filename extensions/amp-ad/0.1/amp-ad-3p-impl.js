...
export class AmpAd3PImpl extends AMP.BaseElement {
  ...
  constructor(element) {
    ...
    console.log('AmpAd3PImpl constructed %o!', this);
  ...
  /** @returns {string} */
  getFormat() {
    return this.element.getAttribute('data-format') || '';
  }
   ...
   */
  onLayoutMeasure() {
    console.log('amp-ad-3p-impl.js onLayoutMeasure fmt=%o for %o',
        this.getFormat(), this);

    if (!this.resizeRequest_ && this.getFormat() !== '') {
